...
public class Player {
	...
	// Files
	final static File file_1L = new File("res/lg_head.jpg");
	final static File file_g = new File("res/green.gif");
	final static File file_blu = new File("res/blue.gif");
	final static File file_r = new File("res/red.gif");
	final static File file_gry = new File("res/grey.gif");
	final static File file_blk = new File("res/black.gif");
	public Image icon = Toolkit.getDefaultToolkit()
			.getImage("res/icon.gif");
	...
	public void mainGUI() throws IOException {
		...
		final JLabel board_img = (new JLabel(new ImageIcon(
				ImageIO.read(new File("res/board.gif")))));
